...
/*   Updated: 2018/01/11 16:53:58 by qdequele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
	...
	std::cout << std::endl;
	SuperTrap super("Quentin");
	std::cout << std::endl;
	super.meleeAttack("Morgane");
	std::cout << std::endl;
	super.beRepared(30);
	std::cout << std::endl;
	super.rangedAttack("Alex");
	std::cout << std::endl;
	super.takeDamage(60);
	std::cout << std::endl;
	super.beRepared(30);
	std::cout << std::endl;
	super.ninjaShoebox("Alex");
	std::cout << std::endl;
	super.ninjaShoebox("Morgane");
	std::cout << std::endl;
	super.vaulthunter_dot_exe("Alex");
	std::cout << std::endl;
	super.vaulthunter_dot_exe("Morgane");
	std::cout << std::endl;
	super.status();
	std::cout << std::endl;
	super.takeDamage(70);
