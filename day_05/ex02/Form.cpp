...
/*   Updated: 2018/01/15 15:42:30 by qdequele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream & operator<<( std::ostream & o, Form const & f) {
	...
	o << f.getName() << " must be sign by grade : " << f.getGradeToSign() << " or more and must be executed by grade : " << f.getGradeToExecute() << isSigned;
	return o;
}
